...
using ACME.CargoApp.API.IAM.Infrastructure.Pipeline.Middleware.Attributes;
using ACME.CargoApp.API.IAM.Interfaces.REST.Transform;
using Microsoft.AspNetCore.Mvc;

namespace ACME.CargoApp.API.IAM.Interfaces.REST;
...
public class IamUsersController(IUserQueryService userQueryService) : ControllerBase
{
    /**
     * <summary>
