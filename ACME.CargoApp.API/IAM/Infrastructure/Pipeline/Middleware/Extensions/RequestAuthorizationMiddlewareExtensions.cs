using ACME.CargoApp.API.IAM.Infrastructure.Pipeline.Middleware.Components;

namespace ACME.CargoApp.API.IAM.Infrastructure.Pipeline.Middleware.Extensions;
